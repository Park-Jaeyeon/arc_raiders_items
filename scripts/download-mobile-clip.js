...
const MODEL_ID = 'Xenova/mobileclip-b-lt-openclip';
const OUTPUT_DIR = path.resolve(__dirname, '../public/models/mobileclip-b-lt-openclip');
...
const FILES = {
  ...
  // Ensure we maintain the directory structure expected by transformers.js
...
async function main() {
  // Clean previous attempts to ensure integrity
